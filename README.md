...
- **小伙伴乐园**：为 3–5 岁孩子设计的九个互动游戏，共用可换颜色、戴蝴蝶结或皇冠的小怪兽“抱抱”。
...
从彩虹小岛点击「小伙伴乐园」。在抱抱的小家里可以换颜色、换装扮，选择九个不同的小世界。完成的饮料配方、装扮、照顾次数、找朋友进度和英语词语保存在本机。

<img width="900" alt="小伙伴乐园：抱抱的小家和九个互动游戏" src="./docs/images/buddy-home.png">
