...
> 新首页：**绒绒衣橱 · Little Wardrobe**——真实 3D 娃娃、360° 转身、36 件服饰、三个互动场景、拍照姿势、贴纸相册和自动存档。[玩法、画面和验收记录](docs/dress_up/README.md)。左上角「更多游戏」进入小怪兽的胡闹小镇，原有颜色实验室仍可从小镇进入。
...
<img width="900" alt="小伙伴乐园：抱抱的小家和新玩具世界" src="./docs/images/buddy-home.png">

| 怪兽果汁屋 | 小怪兽洗澡澡 | 英语躲猫猫 |
| --- | --- | --- |
| ![划水果、调饮料](./docs/images/buddy-juice.png) | ![给抱抱洗泡泡浴](./docs/images/buddy-bath.png) | ![听英语找动物](./docs/images/buddy-hide.png) |
...
| 天气工厂 | 恐龙托儿所 | 软糖建筑师 |
| --- | --- | --- |
| ![改变天气](./docs/images/buddy-weather.png) | ![照顾小恐龙](./docs/images/buddy-dinosaur.png) | ![搭桥过河](./docs/images/buddy-building.png) |

| 小笨怪学生活 | 动物动作剧场 | 星光烟花工坊 |
| --- | --- | --- |
| ![孩子当老师](./docs/images/buddy-silly.png) | ![编排动作故事](./docs/images/buddy-theater.png) | ![一指烟花](./docs/images/buddy-fireworks.png) |

搭桥设计、动物短剧和恐龙小窝也会自动保存在本机。开启表演或试走软糖桥时，画面会自动回到舞台，方便小屏幕上的孩子观察结果。

## 🦕 抱抱探险队 · 朋友们的恐龙岛

从「彩虹小岛 → 小伙伴乐园 → 抱抱探险队」进入。现在是一条**四个区域、有完整结尾、可以回访的冒险**，不再是上车后只能掉头的河谷样章。

### 主线怎么继续

| 区域 | 操作与下一步 |
| --- | --- |
| **朋友河谷** | 按住道路开车、松手停；拖吊钩搬木搭桥，停稳邀请恐龙上车。**接到伙伴后继续向右，穿过林间出口进入果林。** |
| **丰收果林** | 和恐龙一起推开石头（可长按、拖动或轻点），摇树收四颗果子。把果子拖进篮子，点伙伴分享一颗，再把装着剩下果子的篮子搬上车；也支持轻点装车。向右去山洞。 |
| **萤火山洞** | 拖车灯调整光束，照亮壁画找到拉杆。向下拉或轻点拉杆打开石门，带走星灯，再驶向海湾。 |
| **贝壳海湾** | 将吊篮移到平台边，等小翼龙进篮子，再平稳放回岸边。拉船绳靠岸、等跳板放好，把车开上渡船；再点船绳开船，车和朋友一起返航。 |
| **营地团聚** | 船靠岸后向左开回营地，伙伴下车，果篮、星灯与小翼龙留下。可分享野餐、开关星灯，在右上角「探险绘本」查看纪念卡或回访已去过的地方。 |

所有主要拖动都配有宽容的点选替代；不设倒计时、失败扣分、必须识字或跟读考试。上下车时有动作过渡，上车期间按住道路会在坐稳后继续；跨区域时清除旧手势，避免上一段的按压误操作下一段。

### 新区域画面

| 果林协作 | 萤火山洞 |
| --- | --- |
| ![果林推石与收果](./docs/images/island-orchard-complete-390.png) | ![灯光照亮机关，带走星灯](./docs/images/island-cave-complete-390.png) |

| 海湾吊篮救助 | 带着车和伙伴乘船回家 |
| --- | --- |
| ![小翼龙进入吊篮](./docs/images/island-bay-rescue-390.png) | ![渡船归航](./docs/images/island-sailing-390.png) |

![横屏营地团聚](./docs/images/island-reunion-844.png)

### 英语、画面和反馈

英文在实际动作里出现：**“Push! Together!” “In the basket!” “Look!” “Open!” “Come here!” “On the boat!” “Friends forever!”**。底部语音条可以重听当前操作帮助和英文；自动提示有冷却，静音也能完整玩。

沿用原创纸艺绘本素材和车辆悬挂/车轮动画，新增篮子、星灯、洞门、发光蘑菇、木渡船和翼龙分层素材。推石改变道路、光束确实需要照到目标、吊篮需要靠近平台等待伙伴进入、船靠岸后才可登船；不是按几个按钮后跳到下一张图片。

### 旧样章进度和重玩

- 旧样章未完成：保留车辆、桥和伙伴，从原进度继续。
- 已接到恐龙：继续向右进入新增主线，不必重新搭桥。
- 已经回营地：保留伙伴关系，可以再次带它出发；旧的 `home=true` **不当作全岛通关**。
- 新检查点记录区域、剧情事实和稳定机关状态；船中途退出，恢复到安全甲板重新启航，不把车辆丢在海里。
- 「探险绘本」可返回已访问区域；已打开的路和机关保持。暂停菜单可确认重玩故事，保留旅行纪念计数和其他游戏数据。
...
# 手机横竖屏完整手势路径、截图和视频帧
flutter test tool/island_capture_test.dart --update-goldens
ffmpeg -y -framerate 5.050505 -i build/island-replay/frame-%04d.png \
  -c:v libx264 -pix_fmt yuv420p -crf 20 -movflags +faststart \
  build/island-replay/island-adventure.mp4

# 实际 macOS 应用，从入口走完四区、返航、团聚并重进续玩
flutter drive -d macos --target=tool/expedition_driver_app.dart \
  --driver=tool/expedition_driver_test.dart
```

`build/island-replay/island-adventure.mp4` 是**实际手势驱动的 Widget 场景回放**，不是 iPhone 录屏，也不证明真机帧率。实际原生截图在 `build/island-native/`；原生测试入口使用内存存档，并隔离测试之外的桌面鼠标/焦点事件，普通 `lib/main.dart` 不使用这些隔离。

iOS 保留项目原有 Unity 真机目标和签名配置。本次开发环境没有可连接的 iPhone；手机尺寸、横竖屏与手势测试通过不能替代 iPhone 原生实测。
...
| 滚滚乐 | 怪兽理发店 |
| --- | --- |
| ![可替换机关与连续滚动的小球](./docs/images/play-rolling-action.png) | ![局部剪发与自己的造型](./docs/images/play-salon-action.png) |

| 水流实验室 | 胖胖快递车 |
| --- | --- |
| ![接通水路，蓄水驱动水车](./docs/images/play-water-action.png) | ![途中停进泡泡洗车房](./docs/images/play-delivery-action.png) |

| 果冻小怪 | 声音小火车 |
| --- | --- |
| ![可变形、换表情的软体小怪](./docs/images/play-squishy-action.png) | ![车厢过门，依次播放声音](./docs/images/play-soundTrain-action.png) |

| 影子朋友 | 小小世界 |
| --- | --- |
| ![真实随光源与距离变化的玩具影子](./docs/images/play-shadows-action.png) | ![可改造的微缩场景与持续生活的小动物](./docs/images/play-tinyWorld-action.png) |
